...
var jokes = [
    ...
    'Ngano nga namula ang kamatis? Kay nakita niya ang salad ga dressing.',
    ...
    'Ngano nga gibugnaw ang computer? Kay gibyaan niya ang Windows niya nga nag open.',
    ...
    'Giunsa sa mag-uuma ang pagkwenta sa iyang mga baka? Pinaagi sa cowculator.',
    'Ngano nga nakadawat ug promotion ang scarecrow? Kay siya outstanding sa iyang field.',
...
var kabaloka = [
    'Kabalo ka? Ang dugos dili madaot. Ang mga arkeologo nakakaplag ug mga garapon sa dugos sa karaang mga Egyptian nga mga lubnganan nga sobra sa 3,000 ka tuig ang edad ug magamit pa gihapon.',
    'Kabalo ka? Ang grupo sa mga flamingos gitawag og "flamboyance."',
    'Kabalo ka? Ang mga saging mga berry, apan ang mga strawberry dili.',
    'Kabalo ka? Ang Eiffel Tower mahimong 15 cm taas sa panahon sa ting-init tungod sa thermal expansion sa metal.',
    'Kabalo ka? Ang usa ka octopus adunay tulo ka kasingkasing, siyam ka utok, ug asul nga dugo.',
    'Kabalo ka? Ang pinakabutang gubat sa kasaysayan mao ang tali sa Britain ug Zanzibar niadtong Agosto 27, 1896. Nagsurrender ang Zanzibar pagkahuman sa 38 minutos.',
    'Kabalo ka? Ang poo sa wombat porma sa cube.',
    'Kabalo ka? Ang imbentor sa Pringles can, si Fred Baur, gilubong sa usa niini.',
    'Kabalo ka? Ang mga tawo nagbahin og mga 60% sa ilang DNA sa mga saging.',
    'Kabalo ka? Ang kadaghanan sa imong utok tambok—mga 60%.',
    'Kabalo ka? Ang pinakabutang hiccuping spree nagdugay og 68 ka tuig.',
    'Kabalo ka? Ang bulan adunay moonquakes, sama sa pagyelo sa yuta.',
    'Kabalo ka? Ang mga baka adunay mga best friends ug ma-stress kung mabuwag.',
    'Kabalo ka? Ang kasingkasing sa usa ka blue whale dako kaayo nga usa ka tawo makalanguy sa iyang mga ugat.',
    'Kabalo ka? Ang mga sloth mopalit lamang usa ka beses sa usa ka semana.',
    'Kabalo ka? Ang kadaghanan sa imong mga taste buds naa sa imong dila, apan ang uban naa usab sa imong tutunlan ug sa atop sa imong baba.',
    'Kabalo ka? Ang unang mga orange dili orange—berde sila.',
    'Kabalo ka? Ang usa ka bolt sa kidlat naglangkob ug igo nga enerhiya aron mag-toast ug 100,000 nga slices sa tinapay.',
    'Kabalo ka? Adunay mas daghang mga bituon sa uniberso kaysa mga butil sa balas sa tanang baybayon sa Yuta.',
    'Kabalo ka? Ang mga bee makalupad mas taas pa sa Mount Everest.',
    'Kabalo ka? Dili ka makahum kung nagsira ang imong ilong.',
    'Kabalo ka? Adunay usa ka klase sa jellyfish nga biologically immortal—makabalik kini sa iyang juvenile nga porma pagkahuman sa pagtigulang.',
    'Kabalo ka? Ang usa ka adlaw sa Venus mas taas pa kay sa usa ka tuig sa Venus.',
    'Kabalo ka? Ang fingerprints sa koala halos dili mausab sa mga tawo nga usahay ma-confuse sa usa ka crime scene.',
    'Kabalo ka? Ang hashtag symbol teknikal nga gitawag nga "octothorpe."',
    'Kabalo ka? Ang unang computer virus gimugna niadtong 1983.',
    'Kabalo ka? Ang usa ka kutsara nga dugos nagrepresentar sa kinabuhi nga trabaho sa 12 nga bee.',
    'Kabalo ka? Ang pinakakomong password sa kalibutan mao ang "123456."',
    'Kabalo ka? Ang usa ka tawo makalanguy sa dugo sa usa ka blue whale.',
    'Kabalo ka? Ang average nga tawo maggugol og unom ka bulan sa ilang kinabuhi nga naghulat nga mahimong green ang red lights.',
    'Kabalo ka? Ang init nga tubig mahimong mag-freeze mas paspas kay sa bugnaw nga tubig—usa ka phenomenon nga gitawag nga Mpemba effect.',
    'Kabalo ka? Ang pinakalayong lugar sa Yuta mao ang Point Nemo, usa ka oceanic pole of inaccessibility nga nahimutang sa South Pacific Ocean.',
    'Kabalo ka? Ang ilong sa tawo makamugna og 50,000 nga lain-laing mga amot.',
    'Kabalo ka? Ang kadaghanan sa oxygen nga atong ginahawa naggikan sa dagat, nga gihimo sa phytoplankton.',
    'Kabalo ka? Ang usa ka jiffy usa ka tinuod nga unit sa panahon—1/100th sa usa ka segundo.',
    'Kabalo ka? Adunay mas daghang fake flamingos sa kalibutan kaysa sa tinuod.',
    'Kabalo ka? Ang mga mansanas maglutaw sa tubig tungod kay sila 25% hangin.',
    'Kabalo ka? Ang pinakagamay nga bukog sa lawas sa tawo mao ang stapes bukog, nga nahimutang sa dalunggan.',
    'Kabalo ka? Ang mga giraffe adunay parehong gidaghanon sa neck vertebrae sama sa mga tawo—pito.',
    'Kabalo ka? Ang lawas sa tawo naglangkob sa igo nga tambok aron makahimo ug pito ka bars sa sabon.',
    'Kabalo ka? Ang dot sa ibabaw sa letra nga "i" gitawag nga "tittle."',
    'Kabalo ka? Ang imong kasingkasing mag-uyog sobra sa 100,000 ka beses sa usa ka adlaw.',
    'Kabalo ka? Ang pinakabutang snowflake sa kalibutan gireport nga 15 pulgada ang gilapdon ug 8 pulgada ang kabag.',
    'Kabalo ka? Ang mga snails makatulog hangtod sa tulo ka tuig.',
    'Kabalo ka? Ang pag-purr sa iring adunay gahum sa pag-ayo sa mga bukog ug tisyu.',
    'Kabalo ka? Ang mga dolphin adunay mga ngalan para sa matag usa.',
    'Kabalo ka? Ang unang email gisend ni Ray Tomlinson sa iyang kaugalingon niadtong 1971.',
    'Kabalo ka? Ang usa ka ulap mahimong mag- timbang og sobra sa usa ka milyon ka pounds.',
    'Kabalo ka? Ang mga kangaroo dili makalakaw pabalik.',
    'Kabalo ka? Ang mga lamok maanyag sa mga tawo nga bag-o lang mokaon og saging.',
    'Kabalo ka? Ang crocodile dili makatulis sa iyang dila.',
    'Kabalo ka? Ang average nga adulto nga tawo naglangkob sa mga 7 octillion nga mga atomo.',
    'Kabalo ka? Ang average nga tawo maglakaw sa katumbas sa tulo ka beses sa palibot sa kalibutan sa usa ka kinabuhi.',
    'Kabalo ka? Sa Switzerland, illegal ang pagpanag-iya og usa lang ka guinea pig tungod kay mag-inusara sila.',
    'Kabalo ka? Ang kasingkasing sa shrimp naa sa iyang ulo.',
    'Kabalo ka? Ang mga elepante mao ra ang mga mammals nga dili makalukso.',
    'Kabalo ka? Ang grupo sa mga owls gitawag og parliament.',
    'Kabalo ka? Ang pinakamatanda nga piraso sa chewing gum sa kalibutan mao ang sobra sa 9,000 ka tuig ang edad.',
    'Kabalo ka? Ang usa ka sneeze makalupad hangtod sa 100 milya kada oras.',
    'Kabalo ka? Ang average nga tawo magbuwag og 40 ka pounds sa panit sa ilang kinabuhi.',
    'Kabalo ka? Ang pinakabutang komersyal nga flight sa kalibutan mao ang sa Scotland ug nagdugay lamang og 57 segundos.',
    'Kabalo ka? Ang unicorn mao ang national animal sa Scotland.',
    'Kabalo ka? Adunay mas daghang mga public libraries sa U.S. kaysa McDonald’s restaurants.',
    'Kabalo ka? Ang mga octopus nailhan nga maglupad sa mga butang sa usag usa gikan sa pagdumot.',
    'Kabalo ka? Ang mata sa tawo makadistinguish sa mga 10 milyong lain-laing mga kolor.',
    'Kabalo ka? Ang Amazon rainforest naghimo og 20% sa oxygen sa kalibutan.',
    'Kabalo ka? Ang average nga tawo maggugol og 25 ka tuig sa ilang kinabuhi nga natulog.',
    'Kabalo ka? Ang pinakabutang disyerto sa kalibutan mao ang Antarctica, dili ang Sahara.',
    'Kabalo ka? Ang mga koala makatulog hangtod sa 22 ka oras kada adlaw.',
    'Kabalo ka? Ang kahadlok sa taas nga mga pulong gitawag og "hippopotomonstrosesquipedaliophobia."',
    'Kabalo ka? Ang usa ka adlaw sa Yuta kaniadto 23 ka oras ang gitas-on mga 1.4 bilyon ka tuig ang milabay.',
    'Kabalo ka? Ang Great Wall of China dili makita gikan sa kalangitan sa mata.',
    'Kabalo ka? Ang dila mao ra ang usa ka kalamnan sa lawas sa tawo nga nakabitin sa usa ka tumoy.',
    'Kabalo ka? Ang pinakamatanda nga hotel sa kalibutan nag-operate sukad sa 705 AD.',
    'Kabalo ka? Ang pipila ka mga iring allergic sa mga tawo.',
    'Kabalo ka? Ang tiyan sa tawo makakuha og bag-ong lining matag 3 hangtod 4 ka adlaw aron dili kini mag-digest sa kaugalingon.',
    'Kabalo ka? Ang fingerprints sa lemur halos parehas sa mga tawo.',
    'Kabalo ka? Ang pinakamatanda nga piraso sa chewing gum mao ang 9,000 ka tuig ang edad.',
    'Kabalo ka? Kinahanglan og 1.2 milyong mga lamok, matag usa mosuyop usa ka beses, aron hingpit nga ma-drain ang average nga tawo sa dugo.',
    'Kabalo ka? Ang blue whales mao ang pinakabasag nga mga hayop sa planeta.',
    'Kabalo ka? Ang usa ka letra nga dili makita sa bisan unsang ngalan sa estado sa U.S. mao ang "Q."',
    'Kabalo ka? Ang pinakabutang pangalan sa lugar sa kalibutan mao ang 85 ka letra ang gitas-on.',
    'Kabalo ka? Ang average nga lawas sa tawo naglangkob sa igo nga sulfur aron mapatay ang tanang mga flea sa usa ka average nga iro.',
    'Kabalo ka? Ang mga butterflies makatilaw gamit ang ilang mga tiil.',
    'Kabalo ka? Adunay mas daghang mga fake flamingos sa kalibutan kaysa sa tinuod.',
    'Kabalo ka? Ang mga mansanas maglutaw sa tubig tungod kay sila 25% hangin.',
    'Kabalo ka? Ang pinakagamay nga bukog sa lawas sa tawo mao ang stapes bukog, nga nahimutang sa dalunggan.',
    'Kabalo ka? Ang mga giraffe adunay parehong gidaghanon sa neck vertebrae sama sa mga tawo—pito.',
    'Kabalo ka? Ang lawas sa tawo naglangkob sa igo nga tambok aron makahimo ug pito ka bars sa sabon.',
...
function searchDidyouknow() {
	var index = Math.floor((Math.random() * kabaloka.length) - 1);
	responseMessage.innerText = kabaloka[index];
	showResponse();
}
